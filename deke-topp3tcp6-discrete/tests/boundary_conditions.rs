...
use deke_topp3tcp6_discrete::{BoundaryConditions, SolveStatus, Topp3Tcp6Discrete, Topp3Tcp6DiscreteConstraints};
...
fn perpendicular_velocity_rejects() {
    ...
    let mut cfg = Topp3Tcp6DiscreteConstraints::<6>::symmetric(1.0, 3.0, 200.0);
    cfg.boundary = BoundaryConditions {
