...
use deke_topp3tcp6_discrete::{SolveStatus, TcpLimits, Topp3Tcp6Discrete, Topp3Tcp6DiscreteConstraints};
...
fn seven_dof_rail_dominant_motion() {
    ...
    let mut cfg = Topp3Tcp6DiscreteConstraints::<7>::symmetric(2.0, 10.0, 500.0);
    cfg.tcp = Some(TcpLimits {
        v_max: 0.5,
        a_max: 5.0,
        j_max: 250.0,
