...
use deke_topp3tcp_nlp::continuous::{
    SolveStatus as ContSolveStatus, TcpLimits as ContTcpLimits, Topp3Tcp6, Topp3Tcp6Constraints,
};
...
fn print_rows(rows: &[Row]) {
    ...
    println!(
        "  spd/cnt/dsc       — ok? for topp-speed / continuous topp3tcp6 / discrete topp3tcp6"
    );
    println!();
