...
impl<const N: usize> JointLimits<N> {
    ...
    pub fn symmetric(v_max: f32, a_max: f32, j_max: f32) -> Self {
        Self {
            q_min: SRobotQ::from_array([f32::NEG_INFINITY; N]),
            q_max: SRobotQ::from_array([f32::INFINITY; N]),
...
impl TcpLimits {
    ...
    pub fn is_disabled(&self) -> bool {
        let inactive = |v: f32| v == 0.0 || !v.is_finite();
...
pub struct DensificationOptions {
    ...
    pub max_segment_step: Option<f32>,
